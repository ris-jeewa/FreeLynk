...
public class UserController {
    ...
    @PutMapping("/{userId}")
    public ResponseEntity<User> updateUserProfile(@PathVariable UUID userId, @RequestBody User user) {
    ...
    public ResponseEntity<User> updateUserProfileImage(@PathVariable UUID userId, @RequestBody String imageUrl) {
    ...
    public ResponseEntity<User> updateUserProfileAboutMe(@PathVariable UUID userId, @RequestBody User user) {
    ...
    // @PatchMapping("/{userId}")
    // public ResponseEntity<User> UpdateUserProfileSpecificFields(@PathVariable UUID userId, @RequestBody User user){
